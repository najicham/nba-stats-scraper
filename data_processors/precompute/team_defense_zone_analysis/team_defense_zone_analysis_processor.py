...
class TeamDefenseZoneAnalysisProcessor(
    ...
    def get_upstream_data_check_query(self, start_date: str, end_date: str) -> Optional[str]:
        ...
        Prevents retry storms by checking Phase 3 team_defense_game_summary data exists.
    ...
    def _increment_reprocess_count(self, entity_id: str, analysis_date: date, completeness_pct: float, skip_reason: str) -> None:
        ...
        if circuit_breaker_tripped:
            ...
            circuit_breaker_until = datetime.now(UTC) + timedelta(hours=config.circuit_breaker.entity_lockout_hours)
            logger.error(
