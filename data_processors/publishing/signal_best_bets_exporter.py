        ...
        for system_id, result in pipeline_results.items():
            for candidate in result.candidates:
                all_candidates.append({
                    ...
                    # Pipeline + combo provenance (Task #39 — schema has these, writer was dropping)
                    'pipeline_hr_21d': candidate.get('pipeline_hr_21d'),
                    'pipeline_hr_source': candidate.get('pipeline_hr_source'),
