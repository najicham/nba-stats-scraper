"""
NBA.com Source Handler for Roster Registry

Handles fetching and parsing NBA.com official player list data
with date-matching and fallback logic.
"""
...
class NBASourceHandler:
    """
    Fetches and parses NBA.com official player list data.

    Authority Score: 3 (highest - official source)
    Fallback Window: 7 days (stricter than ESPN/BR)
    """

    def __init__(self, bq_client: bigquery.Client, project_id: str):
        """
        Initialize NBA.com source handler.
    ...
    def _process_detailed_results(self, results: pd.DataFrame) -> Dict[str, Dict]:
        ...
        Args:
            results: DataFrame with NBA.com player list data
