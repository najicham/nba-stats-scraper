...
class AnalyticsProcessorBase(BigQuerySaveOpsMixin, DependencyMixin, MetadataMixin, QualityMixin, TransformProcessorBase, SoftDependencyMixin, RunHistoryMixin):
    """
