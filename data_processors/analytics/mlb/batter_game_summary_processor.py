...
class MlbBatterGameSummaryProcessor(CircuitBreakerMixin, AnalyticsProcessorBase):
    """
    MLB Batter Game Summary Analytics Processor
    ...
    def get_upstream_data_check_query(self, start_date: str, end_date: str) -> Optional[str]:
        ...
        Prevents retry storms by checking if MLB batter stats exist for the date range.
