...
class NbacPlayByPlayProcessor(SmartIdempotencyMixin, ProcessorBase):
    ...
    def transform_data(self) -> None:
        ...
        # opts['file_path'] is set by FileProcessor; fall back to metadata.source_file
        # (which the nbac_play_by_play scraper never writes — broke partition-keyed
        # DELETE/INSERT and silently dropped every load 2025-11-02 onward).
        file_path = (
