# tests/processors/precompute/conftest.py
"""
Pytest configuration for all precompute processor tests.

Mocks Google Cloud dependencies that aren't needed for unit tests.
This file ensures test isolation when running precompute tests alongside
