#!/usr/bin/env python3
"""
Path: tests/processors/precompute/team_defense_zone_analysis/run_tests.py

Test Runner for Team Defense Zone Analysis Processor
...
def run_tests(test_type='all', coverage=False, verbose=False):
    ...
    if coverage:
        cmd.extend([
            '--cov=data_processors.precompute.team_defense_zone_analysis',
            '--cov-report=html',
            '--cov-report=term'
        ])
