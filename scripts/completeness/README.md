...
# Combine filters
./scripts/check-circuit-breaker-status --processor player_daily_cache --active-only
```
...
# Check team
./scripts/check-completeness --entity LAL
```
...
**Action:**
1. Verify override applied: `./scripts/check-circuit-breaker-status --entity <entity>`
...
- **Final Handoff:** `/COMPLETENESS_ROLLOUT_FINAL_HANDOFF.md`
