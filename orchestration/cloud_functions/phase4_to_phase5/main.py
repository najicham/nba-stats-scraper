...
def send_orchestration_error_alert(
    ...
    """
    Send Slack alert when Phase 4→5 orchestrator catches an unexpected exception.
                ...
                "blocks": [
                    {
                        ...
                        "text": {
                            "type": "plain_text",
                            "text": ":rotating_light: Phase 4→5 Orchestrator Error",
                            "emoji": True
                        }
                    },
                    {
    ...
    try:
        ...
        try:
            send_orchestration_error_alert(
                function_name="phase4_to_phase5_orchestrator",
                error=e,
                game_date=game_date if game_date else 'unknown',
