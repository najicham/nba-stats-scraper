...
from orchestration.shared.utils.alert_types import get_alert_html_heading, detect_alert_type
    ...
    def send_error_alert(self, error_message: str, error_details: Dict = None,
        ...
        Args:
            ...
            alert_type: Optional alert type (auto-detected if not provided)
                       See orchestration.shared.utils.alert_types for available types
