...
def retry_on_serialization(func):
    ...
    def wrapper(*args, **kwargs):
        ...
        try:
            ...
            logger.error(
                "BigQuery operation failed after retries" if is_serialization_error(e, exc_info=True) else "BigQuery operation failed",
                extra={
...
def retry_on_quota_exceeded(func):
    ...
    def wrapper(*args, **kwargs):
        ...
        try:
            ...
            logger.error(
                "BigQuery operation failed after quota retries" if is_quota_exceeded_error(e, exc_info=True) else "BigQuery operation failed",
                extra={
...
def retry_on_transient(func):
    ...
    def wrapper(*args, **kwargs):
        ...
        try:
            ...
            logger.error(
                f"BigQuery operation failed after transient retries ({error_type})" if is_transient_error(e) else f"BigQuery operation failed ({error_type}, exc_info=True)",
                extra={
