...
-- Track individual entity failures during Phase 3/4 precompute processing (ENHANCED)
-- Updated: 2025-12-09 (Session 89) - Added DNP vs Data Gap classification
...
OPTIONS (
  description = "Track individual entity failures during Phase 3/4 precompute processing. Enhanced with DNP vs Data Gap classification for failure triage."
);
