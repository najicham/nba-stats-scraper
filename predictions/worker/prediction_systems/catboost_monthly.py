...
MONTHLY_MODELS = {
    ...
    "catboost_v9_train1102_0131_tuned": {
        ...
        "enabled": True,
        "feature_set": "v9",
        "description": "V9_JAN31_TUNED — extended training, tuned params",
    },
    "catboost_v9_q43_train1102_0131": {
        ...
        "enabled": True,
        "feature_set": "v9",
        "description": "Q43_SHADOW — quantile alpha=0.43, staleness-independent edge",
    },
    "catboost_v9_q45_train1102_0131": {
        ...
        "enabled": True,
        "feature_set": "v9",
        "description": "Q45_SHADOW — quantile alpha=0.45, less aggressive than Q43",
    },
}
