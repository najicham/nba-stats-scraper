...
# NOTE: /health/deep is registered below using HealthChecker (line ~2595).
# The inline version was removed in Session 160 because it shadowed the
# HealthChecker-based route that includes the output_schema check (Session 159).
