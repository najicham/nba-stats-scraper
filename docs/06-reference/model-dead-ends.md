...
## Feature Variants
- TeamRankings pace + efficiency (5 features) — Session 408: all <1% importance across 10 seeds. Pace redundant with f7/f14/f22. Efficiency static/seasonal. Same-seed: +0.0pp HR(3+).
