...
|--------|---------|---------|
| `check-circuit-breaker-status` | View circuit breaker status | `./scripts/completeness/check-circuit-breaker-status --active-only` |
| `check-completeness` | Check entity completeness | `./scripts/completeness/check-completeness --entity lebron_james` |
...
**Full Documentation:** [Helper Scripts Guide](03-helper-scripts.md)
...
1. **This Quick Start:** [01-quick-start.md](01-quick-start.md)
2. **Full Runbook:** [02-operational-runbook.md](02-operational-runbook.md) ⭐
3. **Helper Scripts:** [03-helper-scripts.md](03-helper-scripts.md)
4. **Monitoring Guide:** [05-monitoring.md](05-monitoring.md)
...
1. Check the full runbook: [02-operational-runbook.md](02-operational-runbook.md)
2. Review helper scripts: [03-helper-scripts.md](03-helper-scripts.md)
