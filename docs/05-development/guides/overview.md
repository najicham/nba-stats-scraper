...
| **[07-adding-processors-to-pubsub-registry.md](./07-adding-processors-to-pubsub-registry.md)** | How to add new processors to the Pub/Sub registry | Developers | 10 min |
...
├── 03-backfill-deployment-guide.md (Cloud Run deployment)
├── 04-schema-change-process.md (schema changes)
├── 05-processor-documentation-guide.md (documenting processors)
├── 06-bigquery-best-practices.md (BigQuery patterns)
├── 07-adding-processors-to-pubsub-registry.md (Pub/Sub registration)
└── processor-patterns/
    ├── 01-smart-idempotency.md (Phase 2)
    ├── 02-dependency-tracking.md (Phase 3)
    ├── 03-backfill-detection.md (Phase 3)
    ├── 04-smart-reprocessing.md (Phase 3)
    └── 05-phase4-dependency-tracking.md (Phase 4)
```
...
- **Handoff Documents**: `docs/handoff/` directory
...
- **Recent changes**: See `docs/handoff/` directory
- **Architecture decisions**: See `docs/predictions/design/01-architectural-decisions.md`
