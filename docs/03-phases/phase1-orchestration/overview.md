...
**Related Docs:**
- **BigQuery Schemas:** See `03-bigquery-schemas.md` for table structures
- **Troubleshooting:** See `04-troubleshooting.md` for manual operations and fixes
- **Monitoring:** See `docs/monitoring/01-grafana-monitoring-guide.md` for comprehensive monitoring queries
...
│  └───────────────────────────────────────────────────────────┘ │
│  See 03-bigquery-schemas.md for table schemas                 │
└─────────────────────────────────────────────────────────────────┘
                          ↓ HTTP POST /scrape
┌─────────────────────────────────────────────────────────────────┐
...
6. Cleanup Processor runs at 2:15 PM (15 min later)
...
**For BigQuery table schemas:** See `03-bigquery-schemas.md`

**For troubleshooting and manual operations:** See `04-troubleshooting.md`

**For comprehensive monitoring:** See `docs/monitoring/01-grafana-monitoring-guide.md`

**For daily health checks:** See `docs/monitoring/02-grafana-daily-health-check.md`
