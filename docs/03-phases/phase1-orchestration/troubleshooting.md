...
- **Monitoring:** See `docs/monitoring/01-grafana-monitoring-guide.md` and `docs/monitoring/02-grafana-daily-health-check.md`
...
**For BigQuery schemas:** See `03-bigquery-schemas.md`

**For monitoring dashboards:** See `docs/monitoring/01-grafana-monitoring-guide.md` and `docs/monitoring/02-grafana-daily-health-check.md`
