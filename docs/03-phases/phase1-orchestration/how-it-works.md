...
Endpoints:
  ...
  ✅ /evaluate exists (tested locally)
  ✅ /generate-daily-schedule exists (tested locally)
  ✅ /execute-workflows exists (tested locally)
  ✅ /cleanup exists (tested locally)
```
...
❌ Cloud Scheduler Job #2: Master Controller
   Trigger: /evaluate every hour 6 AM-11 PM ET

❌ Cloud Scheduler Job #3: Workflow Executor
   Trigger: /execute-workflows at :05 every hour 6 AM-11 PM ET

❌ Cloud Scheduler Job #4: Cleanup Processor
...
# Job 3: Workflow Executor (5 min after controller)
...
- Name: `nba-scrapers`
- Region: `us-west2`
- Endpoints: `/health`, `/evaluate`, `/generate-daily-schedule`, `/execute-workflows`, `/cleanup`

**Scheduler Jobs:**
- `daily-schedule-locker`: 5 AM ET
- `master-controller-hourly`: 6-11 PM ET (on the hour)
- `execute-workflows`: 6-11 PM ET (at :05)
