...
```json
{
  ...
  "BDL_API_KEY": "cd483b51-304f-4a83-9aa4-8f25fc66eb8c",  ← PLAIN TEXT!
  "ODDS_API_KEY": "5b645db7e6d8a3df08bfcc4abfc8ede1"      ← PLAIN TEXT!
}
```
...
```bash
# Store BDL API key
echo -n "cd483b51-304f-4a83-9aa4-8f25fc66eb8c" | \
...
# Store ODDS API key
echo -n "5b645db7e6d8a3df08bfcc4abfc8ede1" | \
