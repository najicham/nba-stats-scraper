...
> **📚 Main Documentation:** For the authoritative guide on BigQuery loading patterns,
> see [`docs/05-development/guides/bigquery-best-practices.md`](../../../05-development/guides/bigquery-best-practices.md)
>
> This project document contains historical incident context and migration tracking.
