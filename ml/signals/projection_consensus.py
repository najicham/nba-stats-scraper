...
Session 401: When 2+ independent projection sources (NumberFire, FantasyPros)
agree with our model's OVER/UNDER direction relative to the prop line, the
confluence of independent models creates a strong consensus signal.
...
The signal reads from `numberfire_projections` and `fantasypros_projections` raw
BQ tables, joined to predictions via player_lookup.
"""
