"""
Walk-Forward Experiment Infrastructure for CatBoost V8

This module provides tools for running walk-forward validation experiments
to understand optimal training strategies for the CatBoost V8 model.
