#!/usr/bin/env python3
# FILE: backfill_jobs/scrapers/bdb_play_by_play/bdb_play_by_play_backfill_job.py
...
class BigDataBallBackfillJob:
    ...
    def _print_final_summary(self, start_time: datetime):
        ...
        logger.info("   - Begin analytics integration with complete 4-season dataset")
