#!/usr/bin/env python3
"""
FILE: backfill_jobs/scrapers/br_rosters/br_rosters_backfill_job.py
...
Usage:
    python backfill/br_rosters/br_rosters_backfill_job.py --seasons 2022,2023,2024,2025 --group prod
    python backfill/br_rosters/br_rosters_backfill_job.py --teams MEM,LAL --seasons 2024 --debug
    python backfill/br_rosters/br_rosters_backfill_job.py --seasons 2024 --all-teams --debug
    python backfill/br_rosters/br_rosters_backfill_job.py --help
...
# Add project root to path (2 levels up from backfill/br_rosters/)
