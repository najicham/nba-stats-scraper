...
class NbacRefereeBackfill:
    def __init__(self, bucket_name: str = 'nba-scraped-data'):
        ...
        self.alternative_paths = [
            'nba-com/referee-game-line-history',  # alternative pattern
    ...
    def process_file(self, file_path: str) -> Dict:
        ...
        try:
            ...
            if status == 'success':
                ...
                logging.warning(f"⚠ Partial success: {game_assignments} game, {replay_center} replay, errors: {'; '.join(errors)}")
                return {
                    'file_path': file_path,
...
def main():
    ...
    # Default date range: Last 30 days to today (following your pattern)
    if args.start_date:
