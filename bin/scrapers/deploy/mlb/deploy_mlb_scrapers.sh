...
gcloud run deploy $SERVICE_NAME \
    ...
    --update-secrets="DECODO_PROXY_CREDENTIALS=DECODO_PROXY_CREDENTIALS:latest,SLACK_WEBHOOK_URL=slack-webhook-url:latest,BETTINGPROS_API_KEY=bettingpros-api-key:latest,OPENWEATHERMAP_API_KEY=OPENWEATHERMAP_API_KEY:latest" \
    --project $PROJECT_ID
