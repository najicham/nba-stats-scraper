#!/bin/bash
# deploy_mlb_grading.sh - Deploy MLB Phase 6 Grading Service
#
# Grades MLB predictions against actual game results.
#
# Usage: ./bin/phase6/deploy/mlb/deploy_mlb_grading.sh

set -euo pipefail

SERVICE_NAME="mlb-phase6-grading"
REGION="us-west2"
PROJECT_ID="nba-props-platform"

# Docker image configuration
IMAGE_NAME="mlb-grading"
...
echo "========================================"
echo " Deploying MLB Phase 6 Grading"
echo "========================================"
...
if [[ -n "${BREVO_SMTP_PASSWORD:-}" && -n "${EMAIL_ALERTS_TO:-}" ]]; then
    ...
    ENV_VARS="$ENV_VARS,BREVO_FROM_NAME=${BREVO_FROM_NAME:-MLB Grading System}"
...
echo "  $SERVICE_URL/grade-date (POST - HTTP)"
echo ""
